...
- `plugin-check` - Run WordPress Plugin Check and fix issues.
- `plugin-directory` - **NEW** Review plugin against 18 WordPress.org Directory Guidelines before submission.

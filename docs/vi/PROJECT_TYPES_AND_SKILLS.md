...
- `plugin-check` - Chạy kiểm tra và sửa lỗi theo chuẩn WordPress Plugin Check
- `plugin-directory` - **MỚI** Rà soát plugin theo 18 điều khoản WordPress.org Directory Guidelines
